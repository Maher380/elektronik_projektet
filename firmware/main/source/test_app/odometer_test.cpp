/**
 * @file odometer_test.cpp
 * @brief Odometer-only test app, run when ODOMETER_TEST_MODE is defined in main.cpp.
 *
 * @note Remove this file (and the ODOMETER_TEST_MODE define in main.cpp) once no longer needed.
 */
