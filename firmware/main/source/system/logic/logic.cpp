...
void Logic::getEnvironmentPicture() noexcept
{
    ...
    {
        myDistanceToObstacleForward = 70.0f;
         //myIrSensorForward->readDistance();
...
void Logic::decideNormalAction() noexcept
{
    ...
    {
        myPlannedAction.steeringDegrees = -45.0F;
    ...
    if (distanceToClosestObject < 15.0)
    {
        myPlannedAction.speed = -0.50F;
        myPlannedAction.stopMode = driver::motor::StopMode::Coast;
        myPlannedAction.steeringDegrees = -myPlannedAction.steeringDegrees;
    }
...
void Logic::executeAction() noexcept
{
    ...
    else if (myPlannedAction.speed < 0.0F)
    {
        myMotor->setDirection(driver::motor::Direction::Backward);
        myMotor->setSpeed(-myPlannedAction.speed, myPlannedAction.stopMode);
    }
    else
    {
