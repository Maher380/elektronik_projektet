...
PowerShell-testerna under `tools/mqtt/tests` kontrollerar operatorflöden,
konfigurationsgränser och telemetriutskrift. Fullständig ESP-IDF-build,
flashning och fysisk körning ska göras i ESP-IDF-terminalen före användning på
bilen.
