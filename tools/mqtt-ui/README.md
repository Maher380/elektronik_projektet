...
Guiden och MQTT-firmwaren finns i MQTT-PR:n, som ska mergas före denna webbpanel.
...
Demo använder simulerade värden. Avsluta servern med **Ctrl+C** innan du byter läge.
